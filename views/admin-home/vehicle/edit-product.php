...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Edit Vehicle [<?php echo $result->name; ?>]</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" action="<?php echo base_url(); ?>admin/vehicle/product_update" method="post"  enctype="multipart/form-data">
...
//    var fieldHTML = '<label>Product Photo</label><div><input style="float:left" type="file" name="img_name[]" value=""/><a style="float:left" href="javascript:void(0);" class="remove_button"><img src="<?php echo base_url(); ?>resources/images/remove-icon.png"/></a></div><br><br>'; //New input field html 
    ...
    //                                                                        alert(data);
                                    ...
                                    <div class="form-group remove_img_<?php echo $pImg->id; ?>" style="clear:both">
                                        ...
                                        <div>
                                            <div class="col-sm-4">                
                                                <img src="<?php echo base_url(); ?>resources/vehicle-image/<?php echo $pImg->img_name; ?>" height="100" />
                                            </div>
                                            <div class="col-sm-8">                                           
