    ...
    $(document).ready(function () {
        ...
        $("#category_id").change(function (event) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url() ?>admin/electronics/getSubCategory",
                type: "POST",
                data: values,
                cache: false,
                dataType: 'html',
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" action="<?php echo base_url(); ?>admin/electronics/product_save" method="post"  enctype="multipart/form-data">
