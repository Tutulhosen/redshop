...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">All Electronics</h1>
            <a href="<?php echo base_url(); ?>admin/electronics/create_new" class="btn btn-success">Create New Electronics</a>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a style="margin-bottom:5px;" href="<?php echo base_url(); ?>admin/electronics/edit_product/<?php echo $row->id; ?>" class="btn btn-info" target="_blank">Details/ Edit</a>
                                    </td>
...
//                                    $string = character_limiter($string, 20); // another char limit function 
                                    ...
                                    <td>
                                        ...
                                        <img src="<?php echo base_url(); ?>resources/elctronics-image/<?php echo $productImg->img_name; ?>" width="100" />
                                        <?php } ?>
                                    </td>
                                </tr>
   <?php $sl++;
