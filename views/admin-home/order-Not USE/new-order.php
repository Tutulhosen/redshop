...
//                    $('#orderForm')[0].reset();
                    window.location = '<?php echo base_url(); ?>admin/order/create_new';
                },
            });
        });
    }
                                ...
                                <div class="col-lg-12 text-center" style="margin-bottom: 20px">
                                    ...
                                    <select id='selUser' class="but_read form-control" style='width: 500px; font-size: 30px'>
                                        ...
                                        <?php foreach ($product as $row) { ?>
                                            <option value='<?php echo $row->id; ?>'><?php echo $row->product_code.' - '.$row->name; ?></option>  
                                        <?php } ?>
                                    </select>
                                    <br/>
                                    <!--<div id='result'></div>-->
...
<!--                                <div class="form-group">
                                    <label>Mobile</label>                                    
                                    <input type="text" class="form-control mobile" name="mobile" value="" id="input4" placeholder="Mobile Number" >
                                </div>      -->
                                <div class="form-group">
                                    <label>Mobile</label>                                    
                                    <input type="text" class="form-control" name="mobile" value="" id="input3" placeholder="Mobile Number" >
                                </div>  
                                <div class="form-group">
                                    <label>Address</label>                                    
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Note</label>                                    
                                    <textarea class="form-control" cols="10" rows="3" name="description" ></textarea>
                                </div>   
                            </div>
                            <script>
                                $(function () {
