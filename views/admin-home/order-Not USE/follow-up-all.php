...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">All Follow Up Report</h1>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a style="margin-bottom:5px;" href="<?php echo base_url(); ?>admin/order/edit_order/<?php echo $row->id; ?>" class="btn btn-info" target="_blank">Details/ Edit</a>
                                    </td>
