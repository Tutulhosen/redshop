...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">All Packing Sent Report</h1>
    ...
    //                                        alert('hi');
                                        if (confirm('Are you sure you want to do this?')) {
                                                $.ajax({
                                                    type: "post",
                                                    dataType: "html",
                                                    url: '<?php echo base_url(); ?>admin/courier/send_to_courier',
                                                    data: 'order_id=' + order_id,
                                                    success: function (response) {
                                                        //write here any code needed for handling success
                                                        if(response == 'true'){
                                                        $('.message_display').html('Success! Sent to Courier.');
                                     ...
                                     <td>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="order_status_<?php echo $row->id; ?>" name="order_id">
                                                ...
                                                <option value="<?php echo $row->id.'-'.$cou->id; ?>"><?php echo $cou->name; ?></option>
                                                <?php } ?>                                                
                                            </select>
                                        </div>
                                    </td>
