                                        ...
                                        <tbody>
                                            ...
                                            foreach ($result as $row) {
                                                ...
                                                <tr>
                                                    <td><?php echo $sl; ?></td>
                                                    <td class="center">
                                                        <a style="margin-bottom:5px;" href="<?php echo base_url(); ?>admin/user/re_active/<?php echo $row->id; ?>" class="btn btn-warning"  onclick="return confirm('Are you sure?');">Re-active</a>
