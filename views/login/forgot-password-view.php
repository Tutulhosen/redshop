                ...
                <div class="main-container">
                    ...
                    <article id="page-126" class="post-126 page type-page status-publish hentry">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <form action="<?php echo base_url(); ?>forgot_password/passwordRecoveryEmail" method="post">

                                    <div class="form-group">
                                        <label for="email">Email:</label>
                                        <input type="email" class="form-control" id="email" placeholder="Enter email address" name="email" required="" value="">
                                    </div>
